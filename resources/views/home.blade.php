            ...
            <div class="row align-items-end position-relative">
                <div class="col-lg-6">
                    <div class="rts-hero__content w-550">
                        <h1 class="heading" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">We Can Make Your Ideas
                            A Reality
                        </h1>
                    ...
                    <div class="rts-hero__images position-relative">
                        <div class="rts-hero-main">
                            <div class="image-main ">
                                <img class="main top-bottom2" src="assets/images/banner/two/hero__two__illustration.svg" alt="">
                            </div>
